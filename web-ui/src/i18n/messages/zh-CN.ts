...
const zhCN = {
  ...
  header: {
    ...
    brandTitle: '闲鱼监控',
    brandSub: '今天也帮你盯着好货',
    greetingMorning: '早上好，管理员 👋',
    greetingAfternoon: '下午好，管理员 👋',
    greetingEvening: '晚上好，管理员 👋',
  },
  sidebar: {
    dashboard: '监控概览',
    tasks: '任务管理',
  ...
  settings: {
    ...
    ai: {
      ...
      apiMode: 'API 协议',
      streamMode: '响应方式',
      endpointAutoDetect: '智能探测 API 后缀',
      endpointAutoDetectHint: '自动尝试 /v1、Responses 与 Chat Completions，并复用探测缓存。',
      endpointCacheHit: '当前缓存：{mode} / {stream}',
      endpointCacheMiss: '当前配置尚无 endpoint 探测缓存。',
      reasoningEffort: '思考强度',
      reasoningEffortHint: '越高通常会增加分析耗时和 reasoning token 消耗；默认 medium。',
      concurrency: '后台分析并发数',
      concurrencyHint: '待分析商品会进入内存队列，由指定数量的 worker 并发处理；范围 1–32，下次启动任务时生效。',
      proxy: '代理地址 (可选)',
      loading: '正在加载 AI 配置...',
      testConnection: '测试连接',
      save: '保存 AI 设置',
