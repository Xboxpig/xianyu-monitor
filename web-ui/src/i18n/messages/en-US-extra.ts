const enUSExtra = {
  tasks: {
    ...
    toasts: {
      ...
      regenerated: 'AI analysis criteria updated.',
    ...
    generation: {
      title: 'AI Criteria Generation',
      description: 'AI is generating or updating analysis criteria.',
      receiving: 'Receiving streamed output',
      generatedCharacters: '{count} characters generated',
    ...
    form: {
      ...
      keywordRulesHint: 'One keyword per line or comma-separated; alphanumeric keywords match whole words.',
      keywordRulesPlaceholder: 'Example: a7m4\nVerified Authentic\nFull Frame',
      keywordRuleMode: 'Keyword Matching Mode',
      keywordRuleModePlaceholder: 'Select a matching mode',
      keywordRuleModeAny: 'Any match (OR)',
      keywordRuleModeAll: 'All must match (AND)',
      keywordRuleModeHint: 'Any match: an item passes if it matches any keyword. All must match: an item passes only if it matches every keyword.',
      excludeKeywords: 'Exclude Keywords',
      excludeKeywordsHint: 'Items whose title contains any exclude keyword are blocked immediately and never notified. One per line or comma-separated.',
      excludeKeywordsPlaceholder: 'Example: used\ndefective\nkit only',
  ...
  monitor: {
    title: 'Monitor',
    subtitle: 'Pick a task on the left to see its results',
    newTask: 'New monitor task',
    searchTask: 'Search tasks…',
    tasksSummary: '{count} tasks · {running} running',
    running: 'Running',
    idle: 'Idle',
    failed: 'Failed',
    resultsUpdated: 'Updated {time}',
    noTask: 'No tasks yet',
    noTaskHint: 'Click the button above to create your first task',
    emptyResults: 'No results for this task yet',
    allResults: 'All',
    aiRecommended: 'AI picks',
    keywordRecommended: 'Keyword hits',
    runningTasks: '{count} running',
    resultsCount: '{count} items',
  },
  admin: {
    title: 'Admin',
    subtitle: 'Accounts · Notifications · Rules · Logs · System',
    tabs: {
      accounts: 'Accounts',
    ...
    blacklist: {
      ...
      inputPlaceholder: 'Enter keywords to block, press Enter to add',
      add: 'Add',
      hint: 'Regex supported (e.g. iPhone\\s*13). Matched items are hidden automatically.',
      empty: 'No blacklist keywords yet',
      saved: 'Blacklist saved',
      saveFailed: 'Failed to save blacklist',
      noFile: 'This task has no result file yet',
    },
  },
}
