...
const enUS = {
  ...
  settings: {
    ...
    ai: {
      ...
      endpointAutoDetect: 'Detect API suffix automatically',
      endpointAutoDetectHint: 'Tries /v1, Responses, and Chat Completions and reuses the detected route.',
      endpointCacheHit: 'Cached route: {mode} / {stream}',
      endpointCacheMiss: 'No endpoint capability cache exists for this configuration yet.',
      reasoningEffort: 'Reasoning effort',
      reasoningEffortHint: 'Higher levels usually increase latency and reasoning-token usage; defaults to medium.',
      concurrency: 'Background analysis concurrency',
      concurrencyHint: 'Pending items stay in an in-memory queue and are processed by this many workers (1–32). Applies to the next task run.',
