const zhCNExtra = {
  tasks: {
    ...
    generation: {
      title: 'AI 标准生成进度',
      description: 'AI 正在生成或更新分析标准。',
      receiving: '正在接收流式输出',
      generatedCharacters: '已生成 {count} 字符',
    ...
    form: {
      ...
      keywordRules: '关键词规则',
      keywordRulesHint: '每行一个关键词，或使用逗号分隔；纯英数字关键词按完整词匹配。',
      keywordRulesPlaceholder: '示例：a7m4\n验货宝\n全画幅',
      keywordRuleMode: '关键词匹配方式',
      keywordRuleModePlaceholder: '请选择匹配方式',
      keywordRuleModeAny: '任一命中（OR）',
      keywordRuleModeAll: '全部命中（AND）',
      keywordRuleModeHint: '任一命中：满足任意一个关键词即通过；全部命中：必须同时满足所有关键词才通过。',
      excludeKeywords: '排除词',
      excludeKeywordsHint: '商品标题中出现任意排除词即直接拦截，不会通知。每行一个，或使用逗号分隔。',
      excludeKeywordsPlaceholder: '示例：二手\n瑕疵\n单出',
      priceRange: '价格范围',
      minPrice: '最低价',
      maxPrice: '最高价',
      maxPages: '搜索页数',
  ...
  monitor: {
    title: '监控',
    subtitle: '选左侧任务，看右侧商品',
    newTask: '新建监控任务',
    searchTask: '搜索任务…',
    tasksSummary: '共 {count} 个任务 · {running} 个运行中',
    running: '运行中',
    idle: '空闲',
    failed: '失败',
    resultsUpdated: '更新于 {time}',
    noTask: '暂无任务',
    noTaskHint: '点击上方按钮创建第一个监控任务',
    emptyResults: '该任务还没有结果',
    allResults: '全部',
    aiRecommended: 'AI 推荐',
    keywordRecommended: '关键词命中',
    runningTasks: '{count} 个运行中',
    resultsCount: '共 {count} 件',
  },
  admin: {
    title: '管理',
    subtitle: '账号 · 通知 · 规则 · 日志 · 系统',
    tabs: {
      accounts: '账号',
      notifications: '通知',
      blacklist: '黑名单',
    ...
    blacklist: {
      selectTask: '选择任务',
      inputPlaceholder: '输入要屏蔽的关键词，回车添加',
      add: '添加',
      hint: '支持正则表达式（例：iPhone\\s*13）。命中关键词的商品会被自动隐藏。',
      empty: '暂无黑名单关键词',
      saved: '黑名单已保存',
      saveFailed: '保存黑名单失败',
      noFile: '该任务还没有结果文件',
